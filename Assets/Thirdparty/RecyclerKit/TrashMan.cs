...
public class TrashMan : MonoBehaviour
{
	...
	void initializePrefabPools()
	{
		...
		{
			recycleBinCollection = new List<TrashManRecycleBin>();
			return;
		}
	...
	public static void removeRecycleBinByPerfab(GameObject go)
	{
		TrashManRecycleBin recycleBin = recycleBinForGameObject(go);
		if( recycleBin == null) return;
		removeRecycleBin(recycleBin);
	}
