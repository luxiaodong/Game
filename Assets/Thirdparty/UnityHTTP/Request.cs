...
namespace UnityHTTP
{
    ...
    public class Request
    {
        ...
        public int maximumRetryCount = 1;
        public int connectTimeout = 3000; //默认3秒连接超时
        ...
        public Request (string method, string uri, string str)
        {
            this.method = method;
            ...
            {
                this.byteStream = new MemoryStream(Encoding.UTF8.GetBytes( JSON.JsonEncode( str ) ));
