...
namespace XLua.CSObjectWrap
{
    ...
    public class GameCTouchWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Game.CTouch);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Game.CTouch gen_ret = new Game.CTouch();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Game.CTouch constructor!");
		    ...
		    try {
                ...
                
                {
                    ...
                    XLua.LuaTable _tableClass = (XLua.LuaTable)translator.GetObject(L, 2, typeof(XLua.LuaTable));
                        ...
                        Game.CTouch gen_ret = Game.CTouch.Add( _go, _tableClass );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    XLua.LuaTable _table = (XLua.LuaTable)translator.GetObject(L, 2, typeof(XLua.LuaTable));
                        ...
                        XLua.LuaTable gen_ret = Game.CTouch.Get( _go, _table );
                        translator.Push(L, gen_ret);
        ...
        static int _m_SetParent_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    Game.CTouch.SetParent( _go, _parent );
        ...
        static int _m_OnPointerClick(RealStatePtr L)
        {
		    try {
                ...
                Game.CTouch gen_to_be_invoked = (Game.CTouch)translator.FastGetCSObj(L, 1);
