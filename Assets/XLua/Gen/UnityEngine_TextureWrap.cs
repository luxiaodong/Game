    ...
    public class UnityEngineTextureWrap 
    {
        ...
        static int _g_get_wrapMode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Texture gen_to_be_invoked = (UnityEngine.Texture)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineTextureWrapMode(L, gen_to_be_invoked.wrapMode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_wrapModeU(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Texture gen_to_be_invoked = (UnityEngine.Texture)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineTextureWrapMode(L, gen_to_be_invoked.wrapModeU);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_wrapModeV(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Texture gen_to_be_invoked = (UnityEngine.Texture)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineTextureWrapMode(L, gen_to_be_invoked.wrapModeV);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_wrapModeW(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Texture gen_to_be_invoked = (UnityEngine.Texture)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineTextureWrapMode(L, gen_to_be_invoked.wrapModeW);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
