...
namespace XLua.CSObjectWrap
{
    ...
    public class GameCCustomUIWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Game.CCustomUI);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Game.CCustomUI gen_ret = new Game.CCustomUI();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Game.CCustomUI constructor!");
		    ...
		    try {
                ...
                
                {
                    ...
                    XLua.LuaTable _tableClass = (XLua.LuaTable)translator.GetObject(L, 2, typeof(XLua.LuaTable));
                        ...
                        Game.CCustomUI gen_ret = Game.CCustomUI.Add( _go, _tableClass );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    XLua.LuaTable _table = (XLua.LuaTable)translator.GetObject(L, 2, typeof(XLua.LuaTable));
                        ...
                        XLua.LuaTable gen_ret = Game.CCustomUI.Get( _go, _table );
                        translator.Push(L, gen_ret);
        ...
        static int _m_SetParent_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    Game.CCustomUI.SetParent( _go, _parent );
        ...
        static int _g_get_m_luaClass(RealStatePtr L)
        {
		    try {
                ...
                Game.CCustomUI gen_to_be_invoked = (Game.CCustomUI)translator.FastGetCSObj(L, 1);
