...
namespace XLua.CSObjectWrap
{
    ...
    public class GameGXLuaManagerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Game.GXLuaManager);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Game.GXLuaManager gen_ret = new Game.GXLuaManager();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Game.GXLuaManager constructor!");
        ...
        static int _m_GetInstance_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        Game.GXLuaManager gen_ret = Game.GXLuaManager.GetInstance(  );
                        translator.Push(L, gen_ret);
        ...
        static int _m_Init(RealStatePtr L)
        {
		    try {
                ...
                Game.GXLuaManager gen_to_be_invoked = (Game.GXLuaManager)translator.FastGetCSObj(L, 1);
		    ...
		    try {
                ...
                
                {
                    string _fileName = LuaAPI.lua_tostring(L, 1);
                        ...
                        byte[] gen_ret = Game.GXLuaManager.CustomLoader( ref _fileName );
        ...
        static int _m_DoString(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.DoString( _str );
