		    ...
		    try {
                ...
                
                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        UnityEngine.GraphicsBuffer gen_ret = gen_to_be_invoked.GetVertexBuffer( _index );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetIndexBuffer(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        UnityEngine.GraphicsBuffer gen_ret = gen_to_be_invoked.GetIndexBuffer(  );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Rendering.VertexAttribute _attr;translator.Get(L, 2, out _attr);
                        ...
                        int gen_ret = gen_to_be_invoked.GetVertexAttributeStream( _attr );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Rendering.VertexAttribute _attr;translator.Get(L, 2, out _attr);
                        ...
                        int gen_ret = gen_to_be_invoked.GetVertexAttributeOffset( _attr );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    int _stream = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        int gen_ret = gen_to_be_invoked.GetVertexBufferStride( _stream );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
