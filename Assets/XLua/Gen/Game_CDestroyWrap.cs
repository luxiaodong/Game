...
namespace XLua.CSObjectWrap
{
    ...
    public class GameCDestroyWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Game.CDestroy);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Game.CDestroy gen_ret = new Game.CDestroy();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Game.CDestroy constructor!");
		    ...
		    try {
                ...
                
                {
                    ...
                    XLua.LuaTable _tableClass = (XLua.LuaTable)translator.GetObject(L, 2, typeof(XLua.LuaTable));
                        ...
                        Game.CDestroy gen_ret = Game.CDestroy.Add( _go, _tableClass );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    XLua.LuaTable _table = (XLua.LuaTable)translator.GetObject(L, 2, typeof(XLua.LuaTable));
                        ...
                        XLua.LuaTable gen_ret = Game.CDestroy.Get( _go, _table );
                        translator.Push(L, gen_ret);
        ...
        static int _m_SetParent_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    Game.CDestroy.SetParent( _go, _parent );
        ...
        static int _g_get_m_luaClass(RealStatePtr L)
        {
		    try {
                ...
                Game.CDestroy gen_to_be_invoked = (Game.CDestroy)translator.FastGetCSObj(L, 1);
