...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineAudioAudioMixerGroupWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UnityEngine.Audio.AudioMixerGroup);
        ...
        static int _g_get_audioMixer(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Audio.AudioMixerGroup gen_to_be_invoked = (UnityEngine.Audio.AudioMixerGroup)translator.FastGetCSObj(L, 1);
