...
namespace XLua.CSObjectWrap
{
    ...
    public class GameCCoroutineWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Game.CCoroutine);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Game.CCoroutine gen_ret = new Game.CCoroutine();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Game.CCoroutine constructor!");
        ...
        static int _m_YieldAndCallback(RealStatePtr L)
        {
		    try {
                ...
                Game.CCoroutine gen_to_be_invoked = (Game.CCoroutine)translator.FastGetCSObj(L, 1);
