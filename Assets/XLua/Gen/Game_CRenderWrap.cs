...
namespace XLua.CSObjectWrap
{
    ...
    public class GameCRenderWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Game.CRender);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Game.CRender gen_ret = new Game.CRender();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Game.CRender constructor!");
		    ...
		    try {
                ...
                
                {
                    ...
                    XLua.LuaTable _tableClass = (XLua.LuaTable)translator.GetObject(L, 2, typeof(XLua.LuaTable));
                        ...
                        Game.CRender gen_ret = Game.CRender.Add( _go, _tableClass );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    XLua.LuaTable _table = (XLua.LuaTable)translator.GetObject(L, 2, typeof(XLua.LuaTable));
                        ...
                        XLua.LuaTable gen_ret = Game.CRender.Get( _go, _table );
                        translator.Push(L, gen_ret);
        ...
        static int _m_SetParent_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    Game.CRender.SetParent( _go, _parent );
        ...
        static int _g_get_m_luaClass(RealStatePtr L)
        {
		    try {
                ...
                Game.CRender gen_to_be_invoked = (Game.CRender)translator.FastGetCSObj(L, 1);
