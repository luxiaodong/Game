...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineAudioSourceWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 24, 29, 27);
		    ...
		    try {
                ...
                
                {
                    int _slot = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        bool gen_ret = gen_to_be_invoked.PlayOnGamepad( _slot );
        ...
        static int _m_DisableGamepadOutput(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        bool gen_ret = gen_to_be_invoked.DisableGamepadOutput(  );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    int _mixLevel = LuaAPI.xlua_tointeger(L, 3);
                        ...
                        bool gen_ret = gen_to_be_invoked.SetGamepadSpeakerMixLevel( _slot, _mixLevel );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    int _slot = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        bool gen_ret = gen_to_be_invoked.SetGamepadSpeakerMixLevelDefault( _slot );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    bool _restricted = LuaAPI.lua_toboolean(L, 3);
                        ...
                        bool gen_ret = gen_to_be_invoked.SetGamepadSpeakerRestrictedAudio( _slot, _restricted );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    UnityEngine.GamepadSpeakerOutputType _outputType;translator.Get(L, 1, out _outputType);
                        ...
                        bool gen_ret = UnityEngine.AudioSource.GamepadSpeakerSupportsOutputType( _outputType );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        DG.Tweening.Tweener gen_ret = gen_to_be_invoked.DOPitch( _endValue, _duration );
                        translator.Push(L, gen_ret);
