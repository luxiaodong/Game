...
namespace XLua.CSObjectWrap
{
    ...
    public class GameCUpdateWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Game.CUpdate);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Game.CUpdate gen_ret = new Game.CUpdate();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Game.CUpdate constructor!");
		    ...
		    try {
                ...
                
                {
                    ...
                    XLua.LuaTable _tableClass = (XLua.LuaTable)translator.GetObject(L, 2, typeof(XLua.LuaTable));
                        ...
                        Game.CUpdate gen_ret = Game.CUpdate.Add( _go, _tableClass );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    XLua.LuaTable _table = (XLua.LuaTable)translator.GetObject(L, 2, typeof(XLua.LuaTable));
                        ...
                        XLua.LuaTable gen_ret = Game.CUpdate.Get( _go, _table );
                        translator.Push(L, gen_ret);
        ...
        static int _m_SetParent_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    Game.CUpdate.SetParent( _go, _parent );
        ...
        static int _g_get_m_luaClass(RealStatePtr L)
        {
		    try {
                ...
                Game.CUpdate gen_to_be_invoked = (Game.CUpdate)translator.FastGetCSObj(L, 1);
